...
import com.luddosaurus.glasteroids.COORDS_PER_VERTEX
import com.luddosaurus.glasteroids.Mesh
import java.util.*
...
object GLPixelFont {
    private val glyphs = ArrayList<Mesh>(CHAR_COUNT) //a vertex buffer for each glyph, for rendering with OpenGL.
    ...
    private fun createMeshForGlyph(c: Char): Mesh {
        ...
        return Mesh(clean, GLES20.GL_POINTS, norm = false)
    }
}