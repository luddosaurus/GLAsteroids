...
const val OFFSET = 0
private const val TAG = "GLManager"
...
object GLManager {
    ...
    //handle to the color setting
    private var colorUniformHandle = 0

    //handle to the vertex data (eg. coordinates of each vert, thus "positionAttribute")
    private var positionAttributeHandle = 0

    //handle to the model-view-projection matrix
    private var MVPMatrixHandle = 0

    //shader source code (could be loaded from text file!)
